...
var Layout = function() {
    ...
    var resBreakpointMd = 900;//Metronic.getResponsiveBreakpoint('md');
    ...
    var handleSidebarToggler = function() {
        ...
        $('body').on('click', '.sidebar-toggler', function(e) {
            ...
            if (body.hasClass("page-sidebar-closed")) {
                ...
                //hide the non-menu areas in the menu as a hack...
                $('#embeddedProfileItem').show();
