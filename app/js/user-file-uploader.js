...
var myDropzone = new Dropzone(document.body, { // Make the whole body a dropzone
  url: API_ROOT + "api/upload/upload", // Set the url
  headers: headers,
  thumbnailWidth: 80,
  thumbnailHeight: 80,
  parallelUploads: 20,
  ...
  clickable: [".fileinput-button", ".dropzoneClickableTarget"] // Define the element that should be used as click trigger to select files.
});
