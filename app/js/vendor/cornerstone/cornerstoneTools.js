...
var cornerstoneTools = (function($, cornerstone, cornerstoneMath, cornerstoneTools) {
  ...
  function createNewMeasurement(mouseEventData) {
      ...
      startPt.linked = startPt2;
      startPt2.linked = startPt;
      var angleData = {
        visible: true,
        handles: {
          start: startPt,
  ...
  function onImageRendered(e, eventData) {
      ...
      for (var i = 0; i < toolData.data.length; i++) {
        ...
        if ((dx1 * dx2) + (dy1 * dy2) < 0) angle = 180 - angle;
...
var cornerstoneTools = (function($, cornerstone, cornerstoneTools) {
  ...
  function moveHandle(mouseEventData, handle, doneMovingCallback, preventHandleOutsideImage) {
    ...
    function mouseDragCallback(e, eventData) {
      ...
      if (typeof handle.linked != 'undefined') {
        handle.linked.x = handle.x;
        handle.linked.y = handle.y;
      }
      cornerstone.updateImage(element);
    }
