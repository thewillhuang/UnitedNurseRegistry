...
CREATE TABLE IF NOT EXISTS `UNRdb`.`UserLicense` (
  ...
  PRIMARY KEY (`fk_UserLicense_userID`, `licenseNumber`)  COMMENT '',
...
CREATE TABLE IF NOT EXISTS `UNRdb`.`Facility` (
  ...
  `facilityPwHash` VARCHAR(45) NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `UNRdb`.`UserWorkHistory` (
  ...
  `duration` MEDIUMINT(4) NOT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `UNRdb`.`Phone` (
  ...
  `ext` INT NOT NULL COMMENT '',
  `phoneType` VARCHAR(45) NULL COMMENT '',
  PRIMARY KEY (`phoneID`, `phoneNumber`, `ext`)  COMMENT '')
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `UNRdb`.`Shift` (
  ...
  `nurseRating` TINYINT(1) UNSIGNED NULL COMMENT '',
  `facilityRating` TINYINT(1) UNSIGNED NOT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `UNRdb`.`CompletedShift` (
  ...
  PRIMARY KEY (`fk_CompletedShift_shiftID`, `fk_CompletedShift_userID`, `fk_CompletedShift_facilityID`)  COMMENT '',
...
CREATE TABLE IF NOT EXISTS `UNRdb`.`PendingShifts` (
  ...
  PRIMARY KEY (`fk_PendingShifts_shiftID`, `fk_PendingShifts_userID`, `fk_PendingShifts_facilityID`)  COMMENT '',
...
CREATE TABLE IF NOT EXISTS `UNRdb`.`OpenShifts` (
  ...
  PRIMARY KEY (`fk_OpenShifts_shiftID`, `fk_OpenShifts_userID`, `fk_OpenShifts_facilitID`)  COMMENT '',
