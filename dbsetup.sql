...
SHOW WARNINGS;
CREATE INDEX `userGeohash` ON `UNRdb`.`User` (`userGeohash` ASC)  COMMENT '';

SHOW WARNINGS;
CREATE UNIQUE INDEX `userID_UNIQUE` ON `UNRdb`.`User` (`userID` ASC)  COMMENT '';

SHOW WARNINGS;
CREATE UNIQUE INDEX `userName_UNIQUE` ON `UNRdb`.`User` (`userName` ASC)  COMMENT '';
