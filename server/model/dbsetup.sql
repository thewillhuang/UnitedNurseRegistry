...
CREATE TABLE IF NOT EXISTS `UNRdb`.`Shift` (
  ...
  `posted` DATETIME NULL DEFAULT CURRENT_TIMESTAMP COMMENT '',
  `modified` DATETIME NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '',
