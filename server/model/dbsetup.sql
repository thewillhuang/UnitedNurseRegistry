...
CREATE TABLE IF NOT EXISTS `UNRdb`.`betaUser` (
  `email` VARCHAR(255) NOT NULL COMMENT '',
  `signedUp` DATETIME NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '',
...
CREATE TABLE IF NOT EXISTS `UNRdb`.`geohash` (
  ...
  `lat` DECIMAL(11,8) NOT NULL COMMENT '',
  `lng` DECIMAL(11,8) NULL COMMENT '',
