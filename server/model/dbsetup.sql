...
CREATE TABLE IF NOT EXISTS `unrdb`.`User` (
  ...
  `stripe_user_id` VARCHAR(255) NULL COMMENT '',
  `stripe_access_token` VARCHAR(255) NULL COMMENT '',
  `stripe_refresh_token` VARCHAR(255) NULL COMMENT '',
  `stripe_publishable_key` VARCHAR(255) NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `unrdb`.`UserLicense` (
  ...
  `expiration` DATE NOT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `unrdb`.`Specialty` (
  ...
  `specialty` VARCHAR(255) NOT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `unrdb`.`Shift` (
  ...
  `accepted` TINYINT(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '',
  ...
  `shiftDressCode` VARCHAR(255) NOT NULL DEFAULT 'sterile scrubs' COMMENT '',
  `stripeToken` VARCHAR(255) NULL COMMENT '',
  `cents` INT UNSIGNED NOT NULL DEFAULT 0 COMMENT '',
