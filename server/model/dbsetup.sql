...
CREATE TABLE IF NOT EXISTS `UNRdb`.`User` (
  ...
  `userGeohash` VARCHAR(11) NOT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `UNRdb`.`Facility` (
  ...
  `facilityGeohash` VARCHAR(11) NOT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `UNRdb`.`ShiftViewed` (
  ...
  `date` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '',
