...
CREATE TABLE IF NOT EXISTS `UNRdb`.`User` (
  ...
  `userPwHash` VARCHAR(255) NOT NULL DEFAULT 0 COMMENT '',
...
CREATE TABLE IF NOT EXISTS `UNRdb`.`UserLicense` (
  ...
  `licenseVetted` TINYINT(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '',
...
CREATE TABLE IF NOT EXISTS `UNRdb`.`UserWorkHistory` (
  ...
  `workHistoryVetted` TINYINT(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '',
