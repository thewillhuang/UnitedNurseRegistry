...
CREATE TABLE IF NOT EXISTS `UNRdb`.`CompletedShift` (
  ...
  PRIMARY KEY (`fk_CompletedShift_userID`, `fk_CompletedShift_facilityID`)  COMMENT '',
...
CREATE TABLE IF NOT EXISTS `UNRdb`.`PendingShifts` (
  ...
  PRIMARY KEY (`fk_PendingShifts_userID`, `fk_PendingShifts_facilityID`)  COMMENT '',
...
CREATE TABLE IF NOT EXISTS `UNRdb`.`OpenShifts` (
  ...
  PRIMARY KEY (`fk_OpenShifts_userID`, `fk_OpenShifts_facilitID`)  COMMENT '',
